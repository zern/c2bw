...
copy /y "dist\智能图像预处理工具 v3.5_Win7.exe" "dist\c2bw_win7.exe" >nul 2>&1
copy /y "dist\智能图像预处理工具 v3.5_Win7.exe" "dist\c2bw_v3.5_win7.exe" >nul 2>&1

echo.
echo Windows 7 兼容构建完成：
echo - dist\智能图像预处理工具 v3.5_Win7.exe
echo - dist\c2bw_win7.exe
echo - dist\c2bw_v3.5_win7.exe
pause
